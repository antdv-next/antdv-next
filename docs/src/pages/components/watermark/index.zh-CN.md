...
| content | 水印文字内容，传入 `WatermarkText` 对象可为每行单独设置字体样式 | string \| [WatermarkText](#watermarktext) \| (string \| [WatermarkText](#watermarktext))[] | - | - | × |
...
| --- | --- | --- | --- | --- |
| text | 该行文字内容 | string | - | - |
| font | 该行字体样式，会与组件级 `font` 合并 | [Font](#font) | - | - |
