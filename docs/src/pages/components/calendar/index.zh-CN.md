...
| dateFullCellRender | 自定义渲染日期单元格，返回内容覆盖单元格，&gt;= - 请用 `fullCellRender` | (date: DateType) =&gt; VueNode | - | - | × |
...
| 插槽 | 说明 | 类型 | 版本 |
| --- | --- | --- | --- |
| dateFullCellRender | 自定义渲染日期单元格，返回内容覆盖单元格，&gt;= - 请用 `fullCellRender` | (ctx: &#123; date: AnyObject &#125;) =&gt; any | - |
