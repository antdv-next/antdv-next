...
| locale | The i18n text including filter, empty text, item unit, etc | TransferLocale | &#123; itemUnit: `item`, itemsUnit: `items`, notFoundContent: `No data`, searchPlaceholder: `Search here` &#125; | - | × |
