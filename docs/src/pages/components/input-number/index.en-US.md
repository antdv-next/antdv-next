...
| allowClear | If allow to remove input content with clear icon | boolean \| &#123; clearIcon?: VueNode, disabled?: boolean, label?: string &#125; | false | - | × |
...
| clear | Callback when the clear icon is clicked | () =&gt; void | - |
...
| clearIcon | Custom clear icon | () =&gt; any | - |
